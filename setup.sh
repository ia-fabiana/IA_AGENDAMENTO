...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "2. Edit the .env.local file and update (optional for UI preview; data sync disabled without it):"
    echo "   - VITE_SUPABASE_URL=<your-project-url>"
    echo "   - VITE_SUPABASE_ANON_KEY=<your-anon-key>"
    echo ""
    echo "3. Configure the Gemini API key for AI features (required for chat):"
